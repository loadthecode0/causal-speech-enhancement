...
Original file is located at
    https://colab.research.google.com/drive/14oXR3PXUslNUwdPqCbSUmIAXUIrVRgCo
"""
...
def resample_audio_files_in_place(directory, target_sample_rate=8000):
    """
    Resample all audio files in a directory to the target sample rate using torchaudio,
    overwriting the original files.

    Parameters:
        directory (str): Path to the directory containing the audio files to be resampled.
        target_sample_rate (int): The desired sample rate for resampling. Default is 8000 Hz.
    """
